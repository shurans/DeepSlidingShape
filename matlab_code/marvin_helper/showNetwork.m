%jsonfile = '/Users/shuran/Dropbox/marvin/DSS/define_3d/DSSopt_boxreg.json';
jsonfile = '/Users/shuran/Downloads/synth.json'
net = loadjson(jsonfile);
...
LayerType = {'Pooling','Convolution','InnerProduct','Loss','Dropout'   ,'Activation','Softmax','Loss'};
NodeColor = {[.6 .8 1],[1 .7 0.3]   ,[0.5 1 0.],[1 .7 0.7],[.7 0.4 0.9],[.5 0.5 1],[1 0.2 1],[.0 0.8 1]}; 
